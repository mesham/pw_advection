...
#pragma HLS STREAM variable=u_stream depth=4
#pragma HLS STREAM variable=v_stream depth=4
#pragma HLS STREAM variable=w_stream depth=4
#pragma HLS STREAM variable=su_stream depth=4
#pragma HLS STREAM variable=sv_stream depth=4
#pragma HLS STREAM variable=sw_stream depth=4
#pragma HLS STREAM variable=stencil_u_stream depth=4
#pragma HLS STREAM variable=stencil_v_stream depth=4
#pragma HLS STREAM variable=stencil_w_stream depth=4
#pragma HLS STREAM variable=stencil_u_stream_dup depth=4
#pragma HLS STREAM variable=stencil_v_stream_dup depth=4
#pragma HLS STREAM variable=stencil_w_stream_dup depth=4
