...
static void advect_flow_fields(REAL_TYPE*, REAL_TYPE*, REAL_TYPE*, REAL_TYPE*, REAL_TYPE*, REAL_TYPE*, REAL_TYPE[MAX_Z_SIZE], REAL_TYPE[MAX_Z_SIZE],
		REAL_TYPE[MAX_Z_SIZE], REAL_TYPE[MAX_Z_SIZE], REAL_TYPE[MAX_Z_SIZE], REAL_TYPE[MAX_Z_SIZE], REAL_TYPE, REAL_TYPE, unsigned int, unsigned int, unsigned int);
...
extern "C" void pw_advection(REAL_TYPE * u, REAL_TYPE * v, REAL_TYPE * w, REAL_TYPE * su, REAL_TYPE * sv, REAL_TYPE * sw, REAL_TYPE * tzc1, REAL_TYPE * tzc2,
		REAL_TYPE * tzd1, REAL_TYPE * tzd2, REAL_TYPE tcx, REAL_TYPE tcy, unsigned int size_x, unsigned int size_y, unsigned int size_z) {
...
static void advect_flow_fields(REAL_TYPE * u, REAL_TYPE * v, REAL_TYPE * w, REAL_TYPE * su, REAL_TYPE * sv, REAL_TYPE * sw,
...
#pragma HLS STREAM variable=u_stream depth=1
#pragma HLS STREAM variable=v_stream depth=1
#pragma HLS STREAM variable=w_stream depth=1
#pragma HLS STREAM variable=su_stream depth=1
#pragma HLS STREAM variable=sv_stream depth=1
#pragma HLS STREAM variable=sw_stream depth=1
#pragma HLS STREAM variable=stencil_u_stream depth=1
#pragma HLS STREAM variable=stencil_v_stream depth=1
#pragma HLS STREAM variable=stencil_w_stream depth=1
#pragma HLS STREAM variable=stencil_u_stream_dup depth=1
#pragma HLS STREAM variable=stencil_v_stream_dup depth=1
#pragma HLS STREAM variable=stencil_w_stream_dup depth=1
